...
import AssignmentDetail from '~/components/ScoreInput/AssignmentDetail';
import MainInfomation from '~/components/ScoreInput/MainInfomation';
import PoinAndComment from '~/components/ScoreInput/PoinAndComment';
import StudentTable from '~/components/ScoreInput/StudentTable';
