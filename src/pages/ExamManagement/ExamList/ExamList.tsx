...
import { CalendarOrange, DoubleArrow, ICircle, Search } from '~/assets/Icons/Icons';
import ButtonTypeHeader from '~/components/Button/ButtonTypeHeader';
...
import { arrValueExam, headersTable } from '~/assets/Arrays/ExamList/ExamList';
